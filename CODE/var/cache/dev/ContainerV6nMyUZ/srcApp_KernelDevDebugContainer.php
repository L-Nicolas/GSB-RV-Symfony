...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\ModifierMotDePasseController' => 'getModifierMotDePasseControllerService',
            'App\\Controller\\SaisirFraisController' => 'getSaisirFraisControllerService',
    ...
    /**
     * Gets the public 'App\Controller\ModifierMotDePasseController' shared autowired service.
     *
     * @return \App\Controller\ModifierMotDePasseController
     */
    protected function getModifierMotDePasseControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/dependency-injection/ContainerAwareInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/dependency-injection/ContainerAwareTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/Controller.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/ModifierMotDePasseController.php';

        return $this->services['App\\Controller\\ModifierMotDePasseController'] = new \App\Controller\ModifierMotDePasseController(($this->services['twig'] ?? $this->getTwigService()));
    }

    /**
     * Gets the public 'App\Controller\SaisirFraisController' shared autowired service.
     *
     * @return \App\Controller\SaisirFraisController
     */
    protected function getSaisirFraisControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/dependency-injection/ContainerAwareInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/dependency-injection/ContainerAwareTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/Controller.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/SaisirFraisController.php';

        return $this->services['App\\Controller\\SaisirFraisController'] = new \App\Controller\SaisirFraisController(($this->services['twig'] ?? $this->getTwigService()));
    }
